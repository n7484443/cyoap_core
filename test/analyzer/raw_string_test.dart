...
void main(){
  test('raw string getter test', (){
    ...
    db.setValue(r'!@#$%^ &*()-=+_', ValueTypeWrapper(ValueType.string("test1")), ValueTypeLocation.local);
    db.setValue(r'테스트 노드', ValueTypeWrapper(ValueType.string("test2")), ValueTypeLocation.local);
    var strTest1 = r"load('!@#$%^& *()-=+_') == 'test1'";
  ...
  test('raw string setter test', (){
    VariableDataBase db = VariableDataBase();
    var strTest1 = r"var asVar('!@#$%^& *()-=+_') = 'test1'";
